...
# ============================================================================
# 👉 LEER EN CLASE: "Vean cómo este módulo declara `vpc_id` aunque NO
# lo va a usar para nada interno (es un ejemplo simulado). En la vida
# real lo usaría para validar SGs. Lo importante: cada módulo declara
